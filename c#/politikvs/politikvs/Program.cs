...
namespace MyApp
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                if (n.szavazat == Max(jeloltek) && n.part == "-")
                {

                    System.Console.WriteLine($"A legtöbb szavatatott kapott {n.nev}, a független part tagja és {n.szavazat} szavazatott kapott");
                }
